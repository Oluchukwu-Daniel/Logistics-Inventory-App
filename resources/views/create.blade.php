          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <form method="POST" action="/store"  class="form-horizontal" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="text-input" name="name" class="form-control" placeholder="">
                          @error('name')
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="email-input" name="weight" class="form-control" placeholder="In Grams">
                          @error('weight')
														<div class="alert alert-danger">{{$message}}</div>
													@enderror
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="password-input" name="qty" class="form-control" placeholder="">
                          @error('qty')
														<div class="alert alert-danger">{{$message}}</div>
													@enderror
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="password-input" name="colour" class="form-control" placeholder="">
                          @error('colour')
														<div class="alert alert-danger">{{$message}}</div>
													@enderror
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="password-input" name="pickup" class="form-control" placeholder="">
                          @error('pickup')
														<div class="alert alert-danger">{{$message}}</div>
													@enderror
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="password-input" name="destination" class="form-control" placeholder="">
                          @error('destination')
														<div class="alert alert-danger">{{$message}}</div>
													@enderror
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="date" id="email-input" name="pickup_date" class="form-control" placeholder="">
                          @error('pickup_date')
														<div class="alert alert-danger">{{$message}}</div>
													@enderror
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="date" id="email-input" name="delivery_date" class="form-control" placeholder="">
                          @error('delivery_date')
														<div class="alert alert-danger">{{$message}}</div>
													@enderror
                        </div>
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-actions">
                    <a href="#" class="btn-setting d-sm-down-none"><i class="icon-settings"></i></a>
                    <a href="#" class="btn btn-minimize" data-toggle="collapse" data-target="#collapseExample" aria-expanded="true"><i class="icon-arrow-up"></i></a>
